    ...
    <label htmlFor={label} className="relative block rounded-lg border w-full focus-within:border-white outline-none">
      <div className='flex flex-row items-center w-full bg-blue-50 peer-focus:bg-blue-100 rounded-lg'>
        <input
          ...
          id={label}
          className="peer border-none bg-inherit bg-blue-50 focus:bg-blue-100 w-full h-full placeholder-transparent py-2.5 md:py-2 lg:py-2 px-2 xl:py-2 xl:px-3.5 text-sm md:text-sm lg:text-base focus:border-transparent focus:outline-none rounded-l-lg focus:ring-0 required:border-red-500"
